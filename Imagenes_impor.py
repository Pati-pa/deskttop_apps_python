...
def calcular():
       ...
       u = int(a.get()) / int(b.get())
       v= int(a.get()) ** int(b.get())
       w= int(a.get()) // int(b.get())
       x= int(a.get()) % int(b.get())
       ...
       t_resultados.insert(INSERT, f"{a.get()} / {b.get()} = {u} \n")
       t_resultados.insert(INSERT, f"{a.get()} ** {b.get()} = {v} \n")
       t_resultados.insert(INSERT, f"{a.get()} // {b.get()} = {w} \n")
       t_resultados.insert(INSERT, f"{a.get()} % {b.get()} = {x} \n")
